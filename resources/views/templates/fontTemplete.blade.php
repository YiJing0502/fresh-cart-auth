    ...
    <header>
                    ...
                    <div class="dropdown d-none d-md-block">
                        <div class="btn-group">
                            <button class="btn btn-secondary btn-sm dropdown-toggle" type="button"
                                ...
                                <img src="{{ asset('img/icon/english-flag_工作區域 1.png') }}" alt="English-flag"
                            ...
                            <ul class="dropdown-menu">
                                <li class="flag-menu">
                                    <img src="./img/icon/english-flag_工作區域 1.png" alt="English-flag"
                                        class="img-fluid flag">
                                    <span>English</span>
                                </li>
                                <li class="flag-menu">
                                    <img src="./img/icon/germany-flag_工作區域 1.png" alt="germany-flag"
                                        class="img-fluid flag">
                                    <span>Germany</span>
                                </li>
                            </ul>
        ...
        <div class="top-search">
            <div class="container d-flex justify-content-between">
                <div class="top-search-left d-flex align-items-center">
                    <a href="{{ route('front-index') }}" class="freshcart-logo"><img
                            src="{{ asset('img/icon/freshcart-logo.svg') }}" alt=""></a>
                    <form class="d-flex position-relative d-none d-lg-flex" role="search">
                        <input class="form-control me-2" type="search" placeholder="Search for products"
                            aria-label="Search">
                        <button class="btn search-btn position-absolute" type="submit"><i
                ...
                <div class="top-search-right d-flex align-items-center">
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                        ...
                        <div class="offcanvas-header">
                            <img src="./img/icon/freshcart-logo.svg" alt="" class="offcanvas-title"
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button hover-green" type="button"
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body fs-6-7">
                                            ...
                                            <a class="dropdown-item" href="#">Home 5<span
                                                    class="badge light-blue ms-1">New</span></a>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed hover-green" type="button"
                                        ...
                                        <div class="accordion-body fs-6-7">
                                            <ul>
                                                ...
                                                <li class="position-relative mt-3">
                                                    <!--Mega menu 第四列 -->
                                                    <img src="./img/banner/mega-menu-banner.jpeg" alt=""
                                                        class="img-fluid">
                                                    <div class="position-absolute mega-branner">
                                                        <h5>
                                                            Dont miss this <br> offer today.
                                                        </h5>
                                                        <a href="#" class="btn shop-now-btn ms-auto fs-7">Shop
                                                            Now</a>
                                                    </div>
                                                </li>
                                            </ul>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body fs-6-7">
                                            ...
                                            <a class="dropdown-item" href="#">Home 5<span
                                                    class="badge light-blue ms-1">New</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <a href="#">
                                            <button class="accordion-button collapsed hover-green dashboard"
        ...
        <div class="top-nav">
            <div class="container d-none d-lg-flex align-items-center pb-3">
                <a class="" href="{{route('product.type.all')}}">
                    <button type="button" class="btn all-departments-btn d-none d-lg-block fs-6-7">
                        <i class="bi bi-grid me-1"></i>
                        <span>查看所有商品</span>
                    </button>
                </a>
                <ul class="top-nav-menu d-flex p-0 m-0">
                    <li class="top-nav-item">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle hover-green fs-6-7" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <span>Home</span>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#">Home 5<span
                                            class="badge light-blue ms-1">New</span>
                                    </a></li>
                            </ul>
                        </div>
    ...
    <footer class="mt-5  container-fluid w-100 bg-light-blue pt-4 pb-5">
        ...
        <div class="bottom-service container d-flex align-items-center py-3 border-bottom border-top">
            <div class="row w-100">
                        ...
                        <svg width="34" height="28" viewBox="0 0 34 28" fill="none"
                            ...
                            <g clip-path="url(#clip0_2598_6265)">
                                ...
                                <path
                                    ...
                                    fill="#2FABF7" />
                                <path d="M8.50447 11.3309L7.64844 10.4717L8.29046 11.8678L8.50447 11.3309Z"
                                    fill="#2FABF7" />
                                <path
                    ...
                    <div class="ms-3">
                        <svg width="29" height="28" viewBox="0 0 29 28" fill="none"
                            ...
                            <g clip-path="url(#clip0_2598_6200)">
                                <path d="M10.2969 18.022L11.7235 10.022H13.9527L12.5706 18.022H10.2969Z"
                                    fill="#3C58BF" />
                                <path d="M10.2969 18.022L12.1248 10.022H13.9527L12.5706 18.022H10.2969Z"
                                    fill="#293688" />
                                <path
                ...
                <!-- 右邊兩個 -->
                <div
                    class="footer-second-right col-12  justify-content-center  col-lg-7 d-flex  flex-wrap align-items-center">
                    <div class="row">
                        <!-- 倒數第二行右邊apple store -->
                        <div
                            ...
                            <div>
                                <svg width="140" height="40" viewBox="0 0 169 50" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div
                            ...
                            <svg width="140" height="40" viewBox="0 0 173 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                ...
                                <path
                                    ...
                                    fill="white" stroke="white" stroke-width="0.199309" stroke-miterlimit="10" />
                                <path
                                    d="M70.6415 16.259H69.6616V9.68405H67.5474V8.7666H72.7558V9.68405H70.6415V16.259Z"
                                    fill="white" stroke="white" stroke-width="0.199309" stroke-miterlimit="10" />
                                <path d="M76.5215 16.259V8.7666H77.5012V16.259H76.5215Z" fill="white"
                                    stroke="white" stroke-width="0.199309" stroke-miterlimit="10" />
                                <path
                                    d="M81.8334 16.259H80.8536V9.68405H78.7393V8.7666H83.9477V9.68405H81.8334V16.259Z"
                                    fill="white" stroke="white" stroke-width="0.199309" stroke-miterlimit="10" />
                                <path
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_2490_5186" x1="28.2954" y1="39.1147"
                                        x2="2.32484" y2="12.5281" gradientUnits="userSpaceOnUse">
                                    ...
                                    <linearGradient id="paint1_linear_2490_5186" x1="43.5212" y1="25.0013"
                                        x2="5.17795" y2="25.0013" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#FFE000" />
                                        <stop offset="0.4087" stop-color="#FFBD00" />
                                        <stop offset="0.7754" stop-color="#FFA500" />
                                        <stop offset="1" stop-color="#FF9C00" />
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_2490_5186" x1="21.5694" y1="32.5618"
                                        x2="-13.6488" y2="-3.49187" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#FF3A44" />
                                        <stop offset="1" stop-color="#C31162" />
                                    </linearGradient>
                                    <linearGradient id="paint3_linear_2490_5186" x1="-0.601758" y1="39.3523"
                                        x2="15.1248" y2="23.2529" gradientUnits="userSpaceOnUse">
        ...
        <div class="bottom-copyright  container d-flex justify-content-center py-4">
            <div class="row w-100">
                <div class="col-12 col-lg-9 ps-0">© 2022 - 2023 FreshCart eCommerce HTML Template. All rights
                    reserved. Powered
                ...
                <div class="footer-last-right  col-12 col-lg-3 ps-lg-5 d-flex align-items-center">
                    ...
                    <div class="little-box ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="16"
